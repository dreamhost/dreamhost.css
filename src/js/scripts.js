...
// (But since our platform is generally delivered server-side this probably doesn't matter much, but it'd be nice to keep a clean dom)
...
var Toaster = {
	create(title, description, style, persistence, time){
		...
		// remove the animation-delay created by the nth-child loop in _toasterss.scss
		...
		// 	<div class="Toaster__type">
		// 		<svg width="24" height="24" xmlns="http://www.w3.org/2000/svg">${(style) ? `${toasterIcon[style]}` : `${toasterIcon.default}` }</svg>
		// 	</div>
