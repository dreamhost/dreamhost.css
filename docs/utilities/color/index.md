...
<p class="t-l">All colors can be used directly in sass with their variable names or in html via <strong>bg-</strong> for backgrounds or <strong>t-</strong> for text color.</p>
