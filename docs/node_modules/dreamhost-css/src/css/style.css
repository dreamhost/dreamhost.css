...
*/
.Form__input, .Form__select { border: 1px solid #E0E4E8; }

.Form__description, .Form__radio-check-description { color: #5E6D78; font-size: 1rem; }

.Form__input, .Form__radio-check input, .Form__select { outline: none; }

.Form__input, .Form__radio-check, .Form__select { color: #000000; font-size: 1rem; font-family: "Proxima Nova", sans-serif; }
...
.Form__group--stacked .Form__input + .Form__input { margin-top: 1rem; }

.Form__label { color: #434F58; display: block; font-size: 1rem; font-weight: 600; cursor: pointer; max-width: 35rem; }

.Form__description { font-weight: 500; margin-bottom: 0; }

.Form__input { display: block; margin: 0; margin-top: .5rem; width: 100%; border-radius: 3px; padding: .65rem; }

.Form__input:active, .Form__input:focus { box-shadow: 2px 2px 0 0 #E0E4E8; }

.Form__input:active::-webkit-input-placeholder, .Form__input:focus::-webkit-input-placeholder { /* Chrome/Opera/Safari */ color: #fff; }

.Form__input:active::-moz-placeholder, .Form__input:focus::-moz-placeholder { /* Firefox 19+ */ color: #fff; }

.Form__input:active:-ms-input-placeholder, .Form__input:focus:-ms-input-placeholder { /* IE 10+ */ color: #fff; }

.Form__input:active:-moz-placeholder, .Form__input:focus:-moz-placeholder { /* Firefox 18- */ color: #fff; }

.Form__input::placeholder { color: #5E6D78; }

.Form__label > .Form__description { margin-bottom: 1rem; }

textarea.form__input { min-height: 140px; }

.Form__radio-check { cursor: pointer; display: block; padding-left: 1.4rem; position: relative; margin-bottom: 0.5rem; }

.Form__radio-check input { position: absolute; left: 0; top: 2px; }

.Form__radio-check-label { display: block; }

.Form__radio-check-description { display: block; margin-bottom: 1rem; }

.Form__select { border-radius: 3px; -webkit-appearance: none; -moz-appearance: none; padding: 0 0 0 .75rem; background: #F4F6F9; /* Old browsers */ background: -moz-linear-gradient(top, #F4F6F9 0%, #fbfbfd 100%); /* FF3.6-15 */ background: -webkit-linear-gradient(top, #F4F6F9 0%, #fbfbfd 100%); /* Chrome10-25, Safari5.1-6 */ background: linear-gradient(to bottom, #F4F6F9 0%, #fbfbfd 100%); /* W3C, IE10+, FF16+, Chrome26+, Opera12+, Safari7+ */ filter: progid:DXImageTransform.Microsoft.gradient( startColorstr='$lighter-grey', endColorstr='lighten($lighter-grey, 3%)', GradientType=0 ); /* IE6-9 */ display: block; width: 100%; height: 42px; line-height: 42px; cursor: pointer; }

.Form__group--select { position: relative; }

.Form__group--select:after { content: ''; position: absolute; top: 2.7rem; right: 1rem; border-color: #AFBFCA transparent; border-style: solid; border-width: .35rem .35rem 0 .35rem; }
...
*/
.option-box-label { border-radius: 3px; box-shadow: inset 0 0 0 1px #E0E4E8; cursor: pointer; display: block; padding: 1rem; transition: all .2s ease-in-out; }

.option-box-label:hover { background: #F4F6F9; }

.option-box-title { color: #000000; display: block; overflow: hidden; padding-bottom: 0.5rem; text-align: center; transition: all .2s ease-in-out; width: 100%; }

.option-box-content { border-top: 0; color: #434F58; overflow: hidden; text-align: center; transition: all .2s ease-in-out; }

.option-box { display: inline-block; font-size: 1rem; margin-bottom: 0.5rem; margin-right: 0.5rem; vertical-align: top; width: 100%; }

.option-box:hover .option-box-title, .option-box:hover .option-box-content { color: #000000; }

.option-box .form__radio { display: none; }

.option-box .form__radio + .option-box-label { display: block; }

.option-box .form__radio + .option-box-label:active { transform: scale(0.98); }

.option-box .form__radio:checked + .option-box-label { box-shadow: inset 0 0 0 2px #2BADE9; position: relative; }

.option-box .form__radio:checked + .option-box-label:active { transform: scale(1.02); }

.option-box .form__radio:checked + .option-box-label .option-box-title { font-weight: bold; }

.option-box .form__radio:checked + .option-box-label .option-box-content { color: #000000; }

.option-box .form__radio:checked + .option-box-label:hover { background: #fff; }
...
Pills
	...
	Use with _colors.scss colour classes e.g 'pill c-light-blue'

*/
.tag { text-transform: uppercase; background: #2BADE9; color: #fff; display: inline-block; font-weight: bold; font-size: 0.75em; border-radius: 20px; padding: 0.25em 0.75em; }

.tag.tag--square { border-radius: 0; }

.tag.tag--red { background: #FF4A48; }

.tag.tag--turquoise { background: #00CAAA; }

.tag.tag--orange { background: #FFA700; }

.tag-button { position: relative; display: inline-block; }

.tag-button .tag { position: absolute; top: 50%; transform: translateY(-50%); right: 85%; white-space: nowrap; }
